  ...
  describe('target', () => {
    test('6.1 is not a valid target', () => {
      expect(() => preset(null, { target: '6.1' })).toThrow(
        "Preset latest-node 'target' option must one of 6, 6.5, 8, 8.3, 10, 10.13, 11, current."
      );
    });

    ['6', '6.5', '8', '8.3', '10', '10.13', '11', 6, 6.5, 8, 8.3, 10, 10.13, 11, 'current', undefined, null, ''].forEach(target => {
